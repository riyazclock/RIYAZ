...
import com.repository.ComplianceRepository;
import com.repository.DepartmentRepository;
import com.repository.EmployeeRepository;
import com.repository.StatusReportRepository;

public class ControllerEmployeeServlet extends HttpServlet {
	...
	public void requestHelper(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException{
		...
		if(param == null){
			...
			if(param!=null && param.equals("edit")){
				...
				Employee user = employeeRepo.getUserById(userId);
			...
			if(param!=null && param.equals("edit_comment")){
				...
				Status stsrpt = stsrtpRepo.getStatusReportById(srtrptId);
			...
			if(param!=null && param.equals("save_comment") && cancelParm==null){
				...
				Employee loggedInUser = employeeRepo.getUserById(Long.valueOf(currentUserId));
...
//				getCommentList(request, response);
	...
	public void saveUser(Employee user) throws SQLException, IOException{
		employeeRepo = new EmployeeRepository();
	...
	public void saveComment(Status stsrpt) throws SQLException, IOException{
		stsrtpRepo = new StatusReportRepository();
		stsrtpRepo.createStatus(stsrpt);
	}
	
	public void udpateUser(Employee user) throws SQLException, IOException{
		employeeRepo = new EmployeeRepository();
	...
	public void udpateComment(Status stsrpt) throws SQLException, IOException{
		stsrtpRepo = new StatusReportRepository();
		stsrtpRepo.updateStatus(stsrpt);
	}
	...
	public void setLoggedInUser(HttpServletRequest request, HttpServletResponse response) throws IOException, NumberFormatException, SQLException{
		...
		Employee loggedInUser = employeeRepo.getUserById(Long.valueOf(idInString));
